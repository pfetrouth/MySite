...
<!-- login form {s} -->
<form:form class="form-signin" name="form" id="form" role="form" modelAttribute="logInVO" method="post"	action="${pageContext.request.contextPath}/login/doLogin">
	<div class="text-center mb-4">
		<h1 class="h3 mb-3 font-weight-normal">생존 홈</h1>
	</div>
	...
	<p class="mt-5 mb-3 text-muted text-center">© 2020. 생존 홈. All	rights reserved.</p>
